...
/**
 * Class Vif_Walker_Comment
 */
class Vif_Walker_Comment extends Walker_Comment {
			...
			<article id="div-comment-<?php comment_ID(); ?>" class="comment-body">
				<footer class="comment-meta">
					<div class="comment-author vcard">
						 ...
						 */
						if ( vif_is_comment_by_post_author( $comment ) ) {
							printf( '<span class="post-author-badge" aria-hidden="true">%s</span>', vif_get_icon_svg( 'check', 24 ) );
						}
					...
					<div class="comment-metadata">
						...
						<?php
							$edit_comment_icon = vif_get_icon_svg( 'edit', 16 );
