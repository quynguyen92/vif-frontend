...
$discussion = vif_get_discussion_data();
?>
...
<div id="comments" class="<?php echo comments_open() ? 'comments-area' : 'comments-area comments-closed'; ?>">
	...
	if ( have_comments() ) :
		...
		<ol class="comment-list">
			...
			wp_list_comments(
				array(
					'walker'      => new Vif_Walker_Comment(),
					'avatar_size' => vif_get_avatar_size(),
					'short_ping'  => true,
					'style'       => 'ol',
				)
			);
		...
		if ( have_comments() ) :
			$prev_icon     = vif_get_icon_svg( 'chevron_left', 22 );
			$next_icon     = vif_get_icon_svg( 'chevron_right', 22 );
