 ...
 * @since Twenty Nineteen 1.0.0
 */
function vif_switch_theme() {
	switch_theme( WP_DEFAULT_THEME );
	unset( $_GET['activated'] );
	add_action( 'admin_notices', 'vif_upgrade_notice' );
}
add_action( 'after_switch_theme', 'vif_switch_theme' );
...
add_action( 'load-customize.php', 'vif_customize' );
...
add_action( 'template_redirect', 'vif_preview' );
