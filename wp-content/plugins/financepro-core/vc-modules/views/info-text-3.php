...
$heading = $wrapper_css = $icon_css = $title_css = $content_css = $title_top = $title_bottom = '';
...
$title_gap = "margin-top: {$spacing_top}px;";
$title_gap .= "margin-bottom: {$spacing_bottom}px;";
...
<div class="media rt-info-text <?php echo esc_attr( $class );?>" style="<?php echo esc_attr( $wrapper_css );?>" data-color="<?php echo esc_attr( $color );?>" data-hover="<?php echo esc_attr( $hovercolor );?>" data-title-color="<?php echo esc_attr( $title_color );?>" data-title-hover="<?php echo esc_attr( $title_hover_color );?>">
    <div class="pull-left<?php echo ( $icon_style == 'squire' ) ? '' : ' rounded' ;?>">
    ...
    <div class="media-body">
        <h3 class="media-heading" style="<?php echo esc_attr( $title_gap );?><?php if ( empty( $url ) ) { echo 'color:' . $title_color ;  }  ?>"><?php echo wp_kses_post( $heading ); ?></h3>
