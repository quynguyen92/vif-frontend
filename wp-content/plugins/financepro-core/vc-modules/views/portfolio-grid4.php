...
$wp_query   = $query;
?>
<div class="rt-portfolio-layout-4 pfp-wrapper">
	<div class="row auto-clear pfp-layout8">
	<?php if ( have_posts() ) { ?>
		<?php while ( have_posts() ) : the_post();?>
			...
			?>
			<div class="tlp-portfolio-item <?php echo esc_attr( $col_class );?>">
					...
					<figcaption>
						<div class="tlp-overlay">
							...
							<p class="link-icon">
								...
								<a class="pfp-zoom" data-lightbox="layout8" href="<?php the_post_thumbnail_url( 'full' ); ?>"><i class="fa fa-arrows" aria-hidden="true"></i></a>
							</p>
						</div>
					</figcaption>
				</figure>
