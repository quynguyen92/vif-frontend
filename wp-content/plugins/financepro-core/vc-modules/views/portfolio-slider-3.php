...
?>
<div class="rt-portfolio-slider-3 owl-wrap rt-owl-nav-2 pfp-wrapper<?php echo esc_attr( $slider_nav_class );?><?php echo esc_attr( $slider_dot_class );?>">
	<div class="row auto-clear pfp-carousel10">
