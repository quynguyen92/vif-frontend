...
$wp_query   = $query;
?>
<div class="rt-portfolio-layout-4 pfp-wrapper gallery-wrapper" id="inner-isotope">
    <div class="row">
	...
	<div class="row auto-clear rt-isotope2 featuredContainer">
		<?php if ( $query->have_posts() ) { ?>
			...
			?>
			<div class="tlp-portfolio-item <?php echo esc_attr( $col_class );?> <?php echo esc_html( $term_list ); ?>">
					...
					<figcaption>
						<div class="tlp-overlay">
							...
							<p class="link-icon">
								...
								<a class="pfp-zoom" href="<?php the_post_thumbnail_url( 'full' ); ?>"><i class="fa fa-arrows" aria-hidden="true"></i></a>
							</p>
						</div>
					</figcaption>
				</figure>
