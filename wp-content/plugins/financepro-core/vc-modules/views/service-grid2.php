		...
		<div class="<?php echo esc_attr( $col_class ); ?>">
			<div class="rtin-single-feature-slide">
				...
				<div class="rtin-feature-slide-content">				
					...
					<?php if( empty( $service_link ) ) { ?>
					<a class="button btn-flat" href="<?php the_permalink(); ?>">
					<?php } else { ?>
					<a class="button btn-flat" href="<?php echo esc_attr( $service_link );?>">
					<?php } ?>
					<?php esc_html_e( 'READ MORE' , 'financepro-core' ); ?><i class="fa fa-chevron-right" aria-hidden="true"></i>
					</a>					
					<?php if( empty( $service_link ) ) { ?>
					<a class="feature-icon" href="<?php the_permalink(); ?>">
					<?php } else { ?>
					<a class="feature-icon" href="<?php echo esc_attr( $service_link );?>">					
					<?php } ?>					
