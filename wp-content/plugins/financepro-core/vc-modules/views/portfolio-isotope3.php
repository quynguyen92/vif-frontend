...
$wp_query   = $query;
?>
<div class="rt-portfolio-layout-6 pfp-wrapper gallery-wrapper" id="inner-isotope">
    <div class="row">
	...
	<div class="row auto-clear rt-isotope3 featuredContainer">
	<?php if ( have_posts() ) { ?>
		<?php while ( have_posts() ) : the_post();?>
			...
			<div class="<?php echo esc_attr( $col_class );?> <?php echo esc_html( $term_list ); ?>">				
				<div class="tlp-portfolio-item">
					<figure><?php echo wp_kses_post( $thumbnail ); ?>
					<div class="tlp-overlay">
						<div class="item-info">
							<h3 class="title"><a class="tlp-item-details" target="_blank" href="<?php the_permalink(); ?>"><?php the_title();?></a></h3>
							<div class="line"></div>
							<p class="pfp-categories"><?php	echo esc_html( $term_list ); ?></p>
							<p class="short-desc"><?php echo esc_html($content); ?></p>
							<p class="link-icon"><a target="_blank" href="<?php the_permalink(); ?>"><i class="fa fa-external-link"></i></a><a class="pfp-zoom" href="<?php the_post_thumbnail_url( 'full' ); ?>"><i class="fa fa-arrows" aria-hidden="true"></i></a></p>
						</div>
					</div>
					</figure>
				</div>
