...
?>
<div class="rt-portfolio-slider-2 owl-wrap rt-owl-nav-2 pfp-wrapper<?php echo esc_attr( $slider_nav_class );?><?php echo esc_attr( $slider_dot_class );?>">
	<div class="row auto-clear pfp-carousel8">
				...
				<figure class="tlp-portfolio-item">
					...
					<figcaption>
						<div class="tlp-content9">
							...
							<p class="link-icon"><a class="tlp-item-details pfp-popup tlp-single-item-popup" href="<?php the_permalink(); ?>"><i class="fa fa-info"></i></a></p>
						</div>
					</figcaption>
				</figure>
				<?php endwhile;?>
