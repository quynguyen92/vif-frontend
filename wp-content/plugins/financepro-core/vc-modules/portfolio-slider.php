...
if ( !class_exists( 'RDTheme_VC_Portfolio_Slider' ) ) {

	class RDTheme_VC_Portfolio_Slider extends RDTheme_VC_Modules {

		public function __construct(){
			$this->name = __( "FinancePro: Portfolio Slider", 'financepro-core' );
			$this->base = 'finance-vc-portfoilio-slider';
		...
		public function shortcode( $atts, $content = '' ){
			...
			switch ( $layout ) {
				case 'layout3':
					...
					$template = 'portfolio-slider-3';
				break;
				case 'layout2':
					wp_enqueue_style( 'portfolio-grid-5' );
					$template = 'portfolio-slider-2';
				break;	
				default:
					wp_enqueue_style( 'portfolio-grid-4' );
					$template = 'portfolio-slider-1';
				break;
			}
...
new RDTheme_VC_Portfolio_Slider;